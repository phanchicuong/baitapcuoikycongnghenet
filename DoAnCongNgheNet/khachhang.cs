    ...
    public partial class khachhang : Form
    {
       SqlConnection con;
        ...
        private void btn_them_Click(object sender, EventArgs e)
        {
                    ...
                    else
                    {
                        ...
                        //else
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    cmd = con.CreateCommand();
                                    cmd.CommandText = @"SET DATEFORMAT DMY INSERT INTO KHACHHANG VALUES(N'" + txt_makh.Text + @"',N'" + txt_hoten.Text + @"',N'" + txt_ngaysinh.Text + @"',N'" + cbo_gioitinh.Text + @"',N'" + txt_sdt.Text + @"',N'" + txt_diachi.Text + @"')";
                                    cmd.ExecuteNonQuery();
            ...
            {
                cmd = con.CreateCommand();
                cmd.CommandText = "SET DATEFORMAT DMY EXEC nhap_kt_khachhang @id= '" + txt_makh.Text + "',@hoten = N'" + txt_hoten.Text + "',@ngaysinh= '" + txt_ngaysinh.Text + "',@gioitinh=N'" + cbo_gioitinh.Text + "',@SDT = '" + txt_sdt.Text + "',@diachi = N'" + txt_diachi.Text + "'";
                cmd.ExecuteNonQuery();
                LoadData();
            }
        ...
        private void btn_sua_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.CommandText = @"EXEC UpdateKhachHang @id ='" + txt_makh.Text + @"',@hoten =N'" + txt_hoten.Text + @"',@ngaysinh ='" + txt_ngaysinh.Text + @"', @gioitinh ='" + cbo_gioitinh.Text + @"',@SDT ='" + txt_sdt.Text + @"',@quoctich =,@diachi=N'" + txt_diachi.Text + @"'";
                cmd.ExecuteNonQuery();
                LoadData();
            }
            catch
